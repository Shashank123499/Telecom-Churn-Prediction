...
def create_report_pdf(
    ...
    findings = [
        ...
        "Customers paying higher monthly charges show higher churn.",
        "Month-to-month Fiber Optic customers have high churn."
    ]
    ...
    story.append(
        Paragraph(
            "The analysis shows that contract type, tenure, "
            "monthly charges and internet service are important "
...
def report_summary():
    ...
    **{retained_customers:,} customers have remained with the company**.
    ...
    Month-to-month customers and customers with shorter tenure are more
    likely to churn. The highest churn rate is observed among customers
    with month-to-month contracts and Fiber Optic internet service.

    The company can reduce customer churn by encouraging long-term
    contracts, improving the experience of new customers, offering
    targeted plans to high-risk customers, and rewarding loyal customers.

    Overall, a data-driven customer retention strategy can help reduce
    churn and improve long-term customer retention.
    """)
